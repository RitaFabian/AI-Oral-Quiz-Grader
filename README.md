...
To calculate the grade, we compute the Cosine Similarity between the student's vector (
A
...
Usage
Launch the Application: Open your terminal and run the Streamlit server:
...
Open the questions.json file in a simple text editor (like Notepad on Windows or TextEdit on Mac).
The file contains a list of questions. Each question is a block of text enclosed in curly braces { }.
